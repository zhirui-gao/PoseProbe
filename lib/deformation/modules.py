...
from lib.deformation.meta_utils import MetaModule, MetaSequential
from lib.deformation.meta_utils import get_subdict
import numpy as np
...
class FCBlock(MetaModule):
    ...
    def __init__(self, in_features, out_features, num_hidden_layers, hidden_features,
        ...
        nls_and_inits = {'sine':(Sine(), sine_init, first_layer_sine_init,last_layer_sine_init),
                         'relu':(nn.ReLU(inplace=True), init_weights_normal, None,last_layer_sine_init),
...
class SingleBVPNet(MetaModule):
    ...
    def __init__(self, out_features=1, type='sine', in_features=2,  # sine
