...
from lib.bg_nerf.train_settings.default_config import get_joint_pose_nerf_default_config_360_data
...
def get_config():
    ...
    settings_model.start_ratio = edict()
    # settings_model.start_iter.corres = 1000
    settings_model.start_ratio.depth_cons = 0.3

    # dataset
    settings_model.dataset = 'scene_with_shapenet'
    ...
    settings_model.ratio_start_decrease_corres_weight = 0.  # settings_model.ratio_end_joint_nerf_pose_refinement
    settings_model.corres_weight_reduct_at_x_iter = 20000

    settings_model.loss_weight = edict()
    settings_model.loss_weight.render = 0.
    settings_model.loss_weight.corres = -2.  # for 10^
    settings_model.loss_weight.depth_cons = -3
    settings_model.loss_weight.fea_cons = -3
    settings_model.loss_weight.depth_patch = -1
